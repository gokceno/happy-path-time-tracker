...
export default function TimersRoute() {
  ...
  return (
    <Dialog.Root
      defaultOpen="true"
      onOpenChange={() => (location.href = `/dashboard/daily/${day}`)}
    >
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-primary-dark-night/[0.32]" />
        <Dialog.Content className="overflow-y-auto font-primary-small-body-h5-semibold absolute top-[calc(50%_-_258px)] left-[calc(50%_-_197px)] rounded-2xl bg-primary-real-white shadow-[0px_8px_16px_rgba(31,_45,_61,_0.24)] w-[395px] flex flex-col py-6 px-0 box-border items-start justify-start text-sm">
