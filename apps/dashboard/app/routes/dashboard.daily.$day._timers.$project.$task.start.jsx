...
export default function TimerStartRoute() {
  ...
  return (
    <div className="self-stretch flex flex-col p-6 items-center justify-start z-[2] text-shades-of-cadet-gray-cadet-gray-600">
      ...
      <button className="cursor-pointer [border:none] mt-3 p-3 bg-shades-of-teal-teal-300 self-stretch rounded-9xl h-12 flex flex-row box-border items-center justify-center relative gap-[8px]">
