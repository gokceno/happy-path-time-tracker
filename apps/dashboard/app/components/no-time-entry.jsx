      ...
      <div className="flex flex-col items-start justify-center gap-[32px]">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          <h4 className="m-0 self-stretch relative text-[inherit] leading-[133%] font-medium font-inherit text-shades-of-cadet-gray-cadet-gray-600">
            ...
            <p>Or you can head back to Slack or <a className="text-shades-of-cadet-gray-cadet-gray-600" href="https://github.com/BrewInteractive/happy-path-macos-client/releases">download the MacOS app</a> to start a new timer. Your options are limitless 😀</p>
          </h4>
        </div>
      </div>
    </div>
